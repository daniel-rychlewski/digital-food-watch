...
struct CryptoActivity : View {
    ...
    private func refreshCode() {
        ...
        if (isNativeTicked && isPolygonTicked) {
            ...
            // Currency
            if (isUsdcTicked) {
                url += "0x3c499c542cef5e3811e1192ce70d8cc03d5c3359"
            } else if (isUsdtTicked) {
                url += "0xc2132d05d31c914a87c6611c10748aeb04b58e8f"
            }
            ...
            // Currency
            if (isUsdcTicked) {
                url += "EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v"
            } else if (isUsdtTicked) {
                url += "Es9vMFrzaCERmJfrF4H2FYD4KCoNkY11McCe8BenwNYB"
            }
            ...
            if (isUsdcTicked) {
                if (isPolygonTicked) {
                    url += "c966_t0x3c499c542cef5e3811e1192ce70d8cc03d5c3359"
                } else if (isSolanaTicked) {
                    url += "c501_tEPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v"
                }
            } else if (isUsdtTicked) {
                if (isPolygonTicked) {
                    url += "c966_t0xc2132d05d31c914a87c6611c10748aeb04b58e8f"
                } else if (isSolanaTicked) {
                    url += "c501_tEs9vMFrzaCERmJfrF4H2FYD4KCoNkY11McCe8BenwNYB"
                }
            }
